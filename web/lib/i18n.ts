...
export const en = {
  ...
  "limits.l5.d":
    "It needs another Todu user within about 100 m. In an empty field at 3am it will not save you. The siren and 112 will still be there.",
...
export const te: Dict = {
  ...
  "offline.l4.tag": "ప్రయత్నం మాత్రమే",
  ...
  "limits.l5.d":
    "సుమారు 100 మీటర్ల లోపల మరో Todu వాడకరి ఉండాలి. తెల్లవారుజామున ఖాళీ పొలంలో అది మిమ్మల్ని కాపాడలేదు. సైరన్, 112 మాత్రం అప్పుడూ ఉంటాయి.",
...
export const hi: Dict = {
  ...
  "limits.l5.d":
    "इसके लिए लगभग 100 मीटर के भीतर कोई दूसरा Todu उपयोगकर्ता चाहिए। रात तीन बजे सुनसान मैदान में यह आपको नहीं बचाएगा। सायरन और 112 तब भी मौजूद रहेंगे।",
