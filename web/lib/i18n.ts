...
export const en = {
  ...
  "dash.photos": "Evidence photos",
  "dash.photoAlt": "Evidence photo {n} from the phone",
...
export const te: Dict = {
  ...
  "dash.photos": "సాక్ష్య ఫోటోలు",
  "dash.photoAlt": "ఫోన్ నుండి సాక్ష్య ఫోటో {n}",
...
export const hi: Dict = {
  ...
  "dash.photos": "सबूत की फ़ोटो",
  "dash.photoAlt": "फ़ोन से सबूत की फ़ोटो {n}",
